const ProjectKuli2 = () => {
    return (
        <div className="max-w-screen-xl rounded-2xl bg-bgresto bg-center mx-auto h-96 overflow-auto mt-5">
            <div className="container p-16 text-neutral-200">
                <p className="text-sm mb-5">Tugas Kuliah Semester 3</p>
