const Footerandi = () => {
    return (
        ...
        <footer className="mt-60 bg-neutral-900 ">
            <div className="mx-auto w-full  p-4 py-6 lg:py-8">
                <div className="md:flex md:max-w-screen-xl mx-auto md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-lg font-bebas  uppercase text-stone-100">Resources</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-lg font-bebas  uppercase text-stone-100">Follow us</h2>
                            <ul className=" text-stone-500 font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-lg font-bebas uppercase text-stone-100">Legal</h2>
                            <ul className=" text-stone-500 font-medium">
                                <li className="mb-4">
                ...
                <div className="sm:flex md:mx-auto sm:items-center sm:justify-between max-w-screen-xl">
                    <span className="text-sm  sm:text-center text-stone-500">© 2023 <a href="https://flowbite.com/" className="hover:underline">Andi Surya™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="#" className=" text-stone-500 dark:hover:text-white">
